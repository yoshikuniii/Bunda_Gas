                ...
                <table class="table table-bordered" width="100%" cellspacing="0">
                    <thead>
                        <tr>
                            ...
                            <th class="col-md-1">Jenis Galon</th>
                            <th class="col-md-1">Jumlah Galon</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{ $i }}</td>
                            <td>{{ $item->jenis_galon }}</td>
                            <td>{{ $item->jumlah_galon }}</td>
                            ...
                            <td>
                                ...
                                <form onsubmit="return confirm('Delete this entry?')" class='d-inline' action="{{ url('dashboard/penjualan_galon/'.$item->id) }}" method="post">
                                    @csrf 
                                    @method('DELETE')
