                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form action="session/login" method="POST" class="user">
                                    	@csrf
                                        <div class="form-group">
                                            <input value="{{ Session::get('email') }}" type="email" name="email" class="form-control form-control-user" aria-describedby="emailHelp" placeholder="Enter Email Address...">
                                        </div>
                                        <div class="form-group">
